<main class="h-screen flex">
  <div class="lg:m-auto lg:max-w-screen-sm shadow-lg w-full bg-white rounded-xl">
    ...
    <div class="shadow h-full px-10 py-14 rounded-xl"> 
      <h1 class="mb-8 font-semibold text-4xl lg:text-5xl text-center">Log in</h1>
      ...
      <form>
        ...
        <button type="submit" class="mt-8 text-xl text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg px-5 py-2.5 text-center w-full">Submit</button>
      </form>
